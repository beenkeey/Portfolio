...
const projects = [
 {
    ...
    type: "Внутренняя корпоративная система",
    ...
    impact: "Сократил время формирования отчетов на ~30% за счет автоматизации KPI",
      ...
      <main className="mx-auto max-w-6xl px-5 pb-14 md:px-10">
        <section id="hero" className="flex min-h-screen items-center py-20">
          <div className="w-full">
            ...
            >
              Разрабатываю backend-системы и автоматизирую бизнес-процессы,
снижая нагрузку на сотрудников и ускоряя работу организаций.
            </motion.p>
            <motion.div
          ...
          <Reveal>
            <div className="glass-card rounded-3xl p-7 md:p-10">
              <SectionTitle
                ...
                subtitle="Открыт к предложениям по backend-разработке и участию в проектах. Готов обсудить задачи, автоматизацию процессов или разработку backend-систем."
              />
